<div id="cajaTitulo" class="text-center p-2 h4 font-weight-bold" style="background-color:gainsboro;"> EDITAR DEPARTAMENTO</div><br><br><br><br>
    ...
    <div class="d-flex flex-column min-vh-80 justify-content-center align-items-center">
        <div class="card p-3 text-light bg-light mb-5">
            <div class="card-header text-center text-dark">
                <h3> Departamento seleccionado </h3>
            </div>
            <div class="card-body w-100">
                <form name="login" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <div class="form-group floating-control-group">
                        ...
                        <input type="text" class="form-control" id="txtFloatingUsername" value="<?php echo $codDepartamento ?>" disabled>
                    </div>
                    <div class="form-group floating-control-group">
                    ...
                    <div class="form-group floating-control-group">
                        ...
                        <input type="text" class="form-control" id="txtFloatingUsername" value="<?php echo $fFechaCreacionDepartamento ?>" disabled>
                    </div><br>
