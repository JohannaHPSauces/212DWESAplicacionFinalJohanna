...
<div class="jumbotron">
    <div class="container">
        ...
        <p>es la n vez que te conectas 
                y la ultima conexion fue x </p>
        ...
        <div class="btn-group me-2" aria-label="Second group">
          <input type="button" class="btn btn-secondary" value="Editar perfil" name="editar"/>
        </div>
        <div class="btn-group"  aria-label="Third group">
          <input type="button" class="btn btn-info" value="Cerrar Sesion" name="cerrar"/>
        </div>
        </div>
    </div>
</div>
